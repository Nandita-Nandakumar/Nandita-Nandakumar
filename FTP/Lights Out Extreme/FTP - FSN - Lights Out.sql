...
AND (v.start_time between '2021-10-29' and '2021-11-01'
OR TIMESTAMP_ADD(v.start_time, INTERVAL v.duration SECOND) between '2021-10-29' and '2021-11-01')
AND tms_id = 'EP031977790006'
GROUP BY 1,2
)
...
WHERE receivedat >= '2021-10-29' and receivedat <= '2021-11-01'
...
WHERE DATE(start_time,'America/New_York') IN ('2021-10-30','2021-10-31')
