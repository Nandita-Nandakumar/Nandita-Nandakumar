...
AND (v.start_time between '2021-12-10' and '2021-12-13'
OR TIMESTAMP_ADD(v.start_time, INTERVAL v.duration SECOND) between '2021-12-10' and '2021-12-13')
AND tms_id = 'EP029977174618'
GROUP BY 1,2
)
...
WHERE DATE(receivedat) >= '2021-12-10' and DATE(receivedat) <= '2021-12-12'
...
AND properties_data_event_context_program_id = 'EP029977174618'
)
...
WHERE DATE(start_time,'America/New_York') IN ('2021-12-11','2021-12-12')
...
AND t1.tms_id = 'EP029977174618'
GROUP BY 1,2,3
)

SELECT 
--DISTINCT userid FROM played_ftp
* FROM nhl_viewership
