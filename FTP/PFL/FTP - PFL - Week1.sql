...
AND (v.start_time between '2022-02-17' and '2022-02-20'
OR TIMESTAMP_ADD(v.start_time, INTERVAL v.duration SECOND) between '2022-02-17' and '2022-02-20')
AND tms_id = 'EP041888580001'
GROUP BY 1,2
)
...
WHERE receivedat >= '2022-02-17' and receivedat <= '2022-02-22'
...
AND properties_data_event_context_program_id = 'EP041888580001'
...
WHERE DATE(start_time,'America/New_York') IN ('2022-02-18', '2022-02-19')
