...
AND (v.start_time between '2022-03-09' and '2022-03-13'
OR TIMESTAMP_ADD(v.start_time, INTERVAL v.duration SECOND) between '2022-03-09' and '2022-03-13')
AND tms_id = 'EP041888580004'
GROUP BY 1,2
)
...
WHERE receivedat >= '2022-03-10' and receivedat <= '2022-03-13'
...
AND properties_data_event_context_program_id = 'EP041888580004'
...
WHERE DATE(start_time,'America/New_York') IN ('2022-03-11', '2022-03-12')
