...
AND (v.start_time between '2022-03-01' and '2022-03-06'
OR TIMESTAMP_ADD(v.start_time, INTERVAL v.duration SECOND) between '2022-03-02' and '2022-03-06')
AND tms_id = 'EP041888580003'
GROUP BY 1,2
)
...
WHERE receivedat >= '2022-03-03' and receivedat <= '2022-03-06'
...
AND properties_data_event_context_program_id = 'EP041888580003'
...
WHERE DATE(start_time,'America/New_York') IN ('2022-03-04')
