...
Select user_id, hours,
 CASE WHEN hours >= 3 THEN 'Core Viewers'
 ELSE 'Casual Viewers' END AS Viewer_type
FRom user_list
...
Select user_id
from (
Select user_id, hours, CASE WHEN hours >= 3 THEN 'Core'
ELSE 'Casual' END AS Viewer_type
FRom user_list
)
WHERE Viewer_type LIKE '%Core%'
LIMIT 125712 
